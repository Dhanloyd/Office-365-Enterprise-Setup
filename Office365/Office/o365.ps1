...
$offlineInstallButton.Add_Click({
    ...
    try {
        ...
        if ($process.ExitCode -eq 0 -or (Test-OfficeInstalled)) {
            ...
            [System.Windows.Forms.MessageBox]::Show("$($translations[$script:currentLanguage]['InstallationFailed']) $($process.ExitCode)", $translations[$script:currentLanguage]['Error'], [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        }
...
$installButton.Add_Click({
    ...
    try {
        ...
        if ($processInstall.ExitCode -eq 0 -or (Test-OfficeInstalled)) {
            ...
            $statusLabel.Text = $translations[$script:currentLanguage]['Error']
            [System.Windows.Forms.MessageBox]::Show("$($translations[$script:currentLanguage]['InstallationFailed']) $($processInstall.ExitCode)", $translations[$script:currentLanguage]['Error'], [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        }
